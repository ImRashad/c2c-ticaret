...
<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"> 
 <div class="settings-details tab-content">
  <div class="tab-pane fade active in" id="Personal">
    <h2 class="title-section">Tamamlanan sifarişlər</h2>
          ...
          while ($sipariscek=$siparissor->fetch(PDO::FETCH_ASSOC)) { $say++; ?>
           ...
           <tr>
            ...
            <?php   }  else if ($sipariscek['siparisdetay_onay']== "0") { ?>                        
             ...
             <center><a href="nedmin/netting/islem.php?siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparisdetay_onay=1&siparis_onay=ok"><button class="btn btn-warning btn-xs" >Gözlənilir...</button></a></center>
           <?php   }  ?>
