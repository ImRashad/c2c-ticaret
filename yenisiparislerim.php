...
<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"> 
  ...
  <div class="settings-details tab-content">
    <div class="tab-pane fade active in" id="Personal">
      <h2 class="title-section">Yeni sifarişlər</h2>
              ...
              <tr>
                ...
                <td>
                  ...
                  if ($sipariscek['siparisdetay_onay']== "1") { ?>
                    ...
                    <center><a href="nedmin/netting/islem.php?siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparisdetay_onay=0&siparis_onay=ok"><button class="btn btn-success btn-xs" >Qəbul edildi...</button></a></center>

                  <?php   }  else if ($sipariscek['siparisdetay_onay']== "0") { ?>                        
                    <center><a id="qebul" href="nedmin/netting/islem.php?siparisdetay_id=<?php echo $sipariscek['siparisdetay_id'] ?>&siparisdetay_onay=1&siparis_onay=ok"><button class="btn btn-warning btn-xs" >Gözlənilir...</button></a></center>
                  <?php   }  ?>
                </td>
...
<script type="text/javascript">
  ...
  $("#qebul").click(function(){

    swal({

      title:"Uğurlar",
      text:"Sifarişi qəbul etdiniz.",
      icon:"succes"
